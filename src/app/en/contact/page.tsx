...
import { ContactFormEN } from "@/components/features/contact/ContactFormEN";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "Beyond Focus — Contact" }],
  },
  alternates: {
    canonical: "https://beyondfocus.pt/en/contact",
          ...
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-[1fr_1.2fr] lg:gap-24">
            ...
            <div>
              ...
              <p className="mt-6 max-w-md text-base leading-relaxed text-petrol/50">
                Have a project in mind? An idea to bring to life? Or just want to know more about what we do? We are just a message away.
              </p>
              ...
              <div className="mt-12 space-y-6">
                ...
                <div>
                  <p className="font-mono text-[11px] uppercase tracking-[2px] text-petrol/30">Location</p>
                  <p className="mt-1 text-base text-petrol">Lisbon, Portugal</p>
                </div>
                <div>
                  <p className="font-mono text-[11px] uppercase tracking-[2px] text-petrol/30">Social media</p>
