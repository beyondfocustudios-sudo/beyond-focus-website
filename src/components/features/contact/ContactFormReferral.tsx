...
export function ContactFormReferral({ referralCode }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch("/api/contact", {
        ...
        body: JSON.stringify({ ...form, referralCode, source: "referral" }),
      });
      if (response.ok) {
        if (typeof window.gtag === "function") {
          window.gtag("event", "referral_submit", {
    ...
    return (
      ...
      >
        ...
        <p className="mx-auto mt-4 max-w-md text-base text-petrol/50">
          Obrigado pelo contacto. O teu desconto de 10% já está reservado. Respondemos em 24 horas.
        </p>
        <a
          href="/"
      ...
      <AnimatePresence mode="wait">
        {step === 1 && (
          ...
          >
            ...
            <div>
              <label htmlFor="ref-name" className="mb-1 block font-mono text-[11px] uppercase tracking-[2px] text-petrol/40">Nome *</label>
              <input
                id="ref-name"
                type="text"
                value={form.name}
            ...
            <div>
              <label htmlFor="ref-email" className="mb-1 block font-mono text-[11px] uppercase tracking-[2px] text-petrol/40">Email *</label>
              <input
                id="ref-email"
                type="email"
                value={form.email}
            ...
            <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
              <div>
                <label htmlFor="ref-phone" className="mb-1 block font-mono text-[11px] uppercase tracking-[2px] text-petrol/40">Telefone *</label>
                <input
                  id="ref-phone"
                  type="tel"
                  value={form.phone}
              ...
              <div>
                <label htmlFor="ref-company" className="mb-1 block font-mono text-[11px] uppercase tracking-[2px] text-petrol/40">Empresa</label>
                <input
                  id="ref-company"
                  type="text"
                  value={form.company}
            ...
            <div>
              <label htmlFor="ref-website" className="mb-1 block font-mono text-[11px] uppercase tracking-[2px] text-petrol/40">Website / Redes sociais</label>
              <input
                id="ref-website"
                type="text"
                value={form.website}
        ...
        {step === 2 && (
          ...
          >
            ...
            <div>
              <label htmlFor="ref-message" className="mb-1 block font-mono text-[11px] uppercase tracking-[2px] text-petrol/40">
        ...
        {step === 3 && (
          ...
          >
            ...
            <div>
              <label htmlFor="ref-startDate" className="mb-1 block font-mono text-[11px] uppercase tracking-[2px] text-petrol/40">
