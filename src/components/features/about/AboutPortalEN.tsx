      ...
      <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
        ...
        >
          ...
          <h2 className="mt-3 text-[clamp(28px,3vw,40px)] leading-tight text-petrol">
            The Beyond Focus Portal.
          </h2>
          <p className="mt-4 max-w-[480px] text-base leading-relaxed text-petrol/60">
            We are not just a production company — we offer an exclusive platform where our clients follow every stage of the project, approve deliverables with comments to the exact second, communicate with the team and access all documents. All in one place.
          </p>
          <Link
            href="/portal-cliente"
