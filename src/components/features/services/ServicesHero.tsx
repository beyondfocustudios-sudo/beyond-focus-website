  ...
  return (
    <section className="bg-petrol-deep pt-[200px] pb-20">
      <div className="mx-auto max-w-[1440px] px-6 md:px-10 lg:px-[60px]">
        ...
        >
          Tudo o que precisas para contar a tua história.
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 15 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          Da estratégia à entrega final, cobrimos todas as fases da produção audiovisual. Cada serviço é pensado para gerar resultados reais.
        </motion.p>
      </div>
    </section>
  );
