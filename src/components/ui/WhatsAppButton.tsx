      ...
      {visible && (
        ...
        >
          ...
          <AnimatePresence>
            {tooltip && (
              <motion.div
                ...
                exit={{ opacity: 0, x: 10 }}
                className="rounded-lg bg-white px-4 py-2 text-sm font-medium text-[#0E3A45] shadow-lg"
              >
          ...
          <button
            ...
            className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-transform hover:scale-110 active:scale-95"
          >
